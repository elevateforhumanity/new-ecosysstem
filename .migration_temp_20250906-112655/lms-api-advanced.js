...
const storage = multer.diskStorage({
  destination: (req, file, cb) => {
    const uploadPath = file.mimetype.startsWith('video/') ? 'uploads/videos/' : 
                      file.mimetype.startsWith('image/') ? 'uploads/images/' : 
                      'uploads/documents/';
    cb(null, uploadPath);
  },
    ...
    const modules = [
      {
        ...
        lessons: [
          { id: 'lesson_1_1', title: 'Introduction', type: 'video', duration: 900 },
          { id: 'lesson_1_2', title: 'Core Principles', type: 'interactive', duration: 1200 },
          { id: 'lesson_1_3', title: 'Quiz', type: 'assessment', duration: 300 }
        ]
      },
      {
        id: 'module_2',
        ...
        lessons: [
          { id: 'lesson_2_1', title: 'Practical Examples', type: 'video', duration: 1500 },
          { id: 'lesson_2_2', title: 'Hands-on Project', type: 'project', duration: 3600 },
          { id: 'lesson_2_3', title: 'Final Assessment', type: 'assessment', duration: 900 }
        ]
      }
    ];
