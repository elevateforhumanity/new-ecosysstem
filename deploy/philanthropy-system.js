...
class PhilanthropySystem {
  ...
  loadPhilanthropyData() {
    return {
      mission: {
        statement: "Expand economic mobility by funding training, credentials, and real job placement for under-resourced communities.",
        vision: "Every motivated learner has the funding, mentorship, and employer linkages to build a stable, well-paid career.",
        founder: {
        ...
        stories: [
          {
            ...
            quote: "The emergency grant for childcare made it possible for me to complete my training. Now I have a stable career in healthcare."
          },
          {
            name: "James Thompson",
            ...
            quote: "As a veteran, the support I received helped me transition to a civilian career in cybersecurity."
          },
          {
            name: "Sarah Chen",
            ...
            quote: "The scholarship removed the financial barrier that was preventing me from advancing my career."
          }
        ]
      },
      giving: {
      ...
      legal: {
        ...
        policies: {
          privacy: "We respect your privacy. We do not sell or trade donor information. We use third-party processors (e.g., Stripe) solely to process your payment securely.",
          giftAcceptance: "We accept gifts of cash, debit/credit, employer matches, and approved in-kind donations (tools, laptops, supplies). We do not accept vehicles, real property, or restricted gifts that conflict with our mission.",
          transparency: "Annual impact and financial reports published each year. All donations tracked and reported according to IRS requirements."
        }
      }
    };
  }
  ...
  async getGivingOptions(req, res) {
    try {
      const giving = {
        ...
        recognition: {
          levels: [
            { name: "Benefactor", amount: 10000, benefits: ["Named scholarship", "Annual dinner invitation", "Impact report"] },
            { name: "Patron", amount: 5000, benefits: ["Quarterly updates", "Facility tour", "Recognition wall"] },
            { name: "Advocate", amount: 2500, benefits: ["Impact updates", "Newsletter", "Tax receipt"] },
            { name: "Supporter", amount: 1000, benefits: ["Thank you letter", "Impact summary", "Tax receipt"] },
            { name: "Friend", amount: 500, benefits: ["Thank you note", "Tax receipt"] }
          ]
        },
        matching: {
          employers: [
