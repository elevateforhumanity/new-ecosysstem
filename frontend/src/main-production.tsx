...
console.log(
  `✅ Sentry: ${import.meta.env.VITE_SENTRY_DSN ? 'Enabled' : 'Disabled'}`
);
console.log(
  `✅ Supabase: ${import.meta.env.VITE_SUPABASE_URL ? 'Configured' : 'Not configured'}`
);
console.log('================================');
    ...
    <ErrorBoundary
      fallback={({ error, resetError }) => (
        ...
        >
          ...
          >
            We've been notified and are working on it. Please try refreshing the
            page.
          </p>
