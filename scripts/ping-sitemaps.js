...
(async () => {
  ...
  const targets = [
    { label: 'Google', url: `https://www.google.com/ping?sitemap=${encodeURIComponent(INDEX_URL)}` },
    { label: 'Bing', url: `https://www.bing.com/ping?sitemap=${encodeURIComponent(INDEX_URL)}` }
  ];
