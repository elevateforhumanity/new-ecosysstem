...
function TailwindCheck() {
  ...
  return ok ? (
    <div className="fixed bottom-3 right-3 z-50 text-xs bg-brand-success text-white px-2 py-1 rounded-md shadow-md">
      Tailwind OK
    </div>
  ) : (
    <div className="fixed bottom-3 right-3 z-50 text-xs bg-brand-danger text-white px-2 py-1 rounded-md shadow-md">
      Tailwind NOT loaded
    </div>
  );
}
...
function Shell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-white text-brand-text flex flex-col">
      ...
      <footer className="border-t border-brand-border py-10 mt-10">
...
function Page({ title, children }: { title: string; children?: React.ReactNode }) {
  return (
    <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="mt-4 text-brand-text leading-relaxed">{children}</div>
    </section>
  );
}
      ...
      <div className="mt-8 grid lg:grid-cols-2 gap-8">
          ...
          <div className="mt-6 space-y-6">
            <div className="flex items-start gap-4">
              <div className="rounded-lg bg-brand-surface p-2">
                <div className="h-6 w-6 bg-brand-info rounded"></div>
              </div>
              <div>
            ...
            <div className="flex items-start gap-4">
              <div className="rounded-lg bg-brand-surface p-2">
                <div className="h-6 w-6 bg-brand-success rounded"></div>
              </div>
              <div>
            ...
            <div className="flex items-start gap-4">
              <div className="rounded-lg bg-brand-surface p-2">
                <div className="h-6 w-6 bg-brand-secondary rounded"></div>
              </div>
              <div>
        ...
        <div className="rounded-2xl border border-brand-border p-8">
          ...
          <div className="mt-6 space-y-6">
            ...
            <div className="flex items-start gap-4">
              <div className="rounded-lg bg-brand-surface p-2">
                <div className="h-6 w-6 bg-brand-danger rounded"></div>
              </div>
              <div>
