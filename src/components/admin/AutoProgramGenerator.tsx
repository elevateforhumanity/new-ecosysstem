...
export function AutoProgramGenerator() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'deployed_national': return 'text-brand-success bg-brand-surface';
      case 'deployed_local': return 'text-brand-info bg-brand-surface';
      case 'approved': return 'text-purple-600 bg-brand-surface';
      case 'testing': return 'text-yellow-600 bg-yellow-100';
      case 'draft': return 'text-brand-text-muted bg-brand-surface-dark';
    ...
    <div className="auto-program-generator">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-brand-text-muted">AI-powered creation and nationwide deployment of network training programs</p>
        </div>
        <button
          ...
          <div key={program.id} className="bg-white border rounded-lg p-6">
              ...
              <div className="flex-1">
                <div className="flex items-center mb-2">
                  ...
                  {program.autoGenerated && (
                    <span className="text-xs bg-brand-surface text-brand-info px-2 py-1 rounded">🤖 AI Generated</span>
                  )}
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
              <div className="bg-brand-surface rounded p-3">
                ...
                <div className="text-lg font-bold text-brand-info">{program.nationalAvailability.availableStates.length}</div>
              ...
              <div className="bg-brand-surface rounded p-3">
                ...
                <div className="text-lg font-bold text-brand-success">{program.nationalAvailability.partnerInstitutions}</div>
              ...
              <div>
                ...
                {selectedProgram.modules.map((module, index) => (
                  <div key={index} className="bg-brand-surface rounded p-3 mb-2">
                    ...
                    <div className="text-xs text-brand-text-light mt-1">Duration: {module.duration}</div>
                  </div>
                ))}
              </div>
