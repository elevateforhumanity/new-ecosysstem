  ...
  return (
    <AppLayout title="About Us">
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '2rem' }}>
        {/* Hero Section */}
        <header style={{ textAlign: 'center', marginBottom: '4rem', padding: '3rem 0', background: 'linear-gradient(135deg, var(--brand-info) 0%, var(--brand-info) 100%)', borderRadius: '12px', color: 'white' }}>
        ...
        <section style={{ marginBottom: '4rem' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
            <div style={{ background: 'var(--brand-surface)', padding: '2rem', borderRadius: '8px' }}>
              <h2 style={{ fontSize: '1.75rem', marginBottom: '1rem', color: 'var(--brand-info)' }}>Our Mission</h2>
            ...
            <div style={{ background: '#f0fdf4', padding: '2rem', borderRadius: '8px' }}>
              <h2 style={{ fontSize: '1.75rem', marginBottom: '1rem', color: 'var(--brand-success)' }}>Our Vision</h2>
              <p style={{ color: 'var(--brand-text)', lineHeight: '1.8' }}>
        ...
        <section style={{ marginBottom: '4rem', background: 'white', padding: '3rem', borderRadius: '8px', border: '1px solid var(--brand-border)' }}>
          ...
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            ...
            <p style={{ fontSize: '1.125rem', lineHeight: '1.8', color: 'var(--brand-text)' }}>
        ...
        {/* What We Do */}
        <section style={{ marginBottom: '4rem' }}>
          <h2 style={{ fontSize: '2rem', marginBottom: '2rem', color: 'var(--brand-text)', textAlign: 'center' }}>What We Do</h2>
        ...
        <section style={{ marginBottom: '4rem', background: 'var(--brand-surface)', padding: '3rem', borderRadius: '8px' }}>
          <h2 style={{ fontSize: '2rem', marginBottom: '2rem', color: 'var(--brand-text)', textAlign: 'center' }}>Certifications & Compliance</h2>
        ...
        {/* CTA Section */}
        <section style={{ textAlign: 'center', background: 'linear-gradient(135deg, var(--brand-info) 0%, var(--brand-info) 100%)', padding: '3rem', borderRadius: '12px', color: 'white' }}>
