  ...
  return (
    <main id="main-content" style={{ padding: '2rem', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <section style={{ marginBottom: '3rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem' }}>
          <div style={{
            ...
            <div style={{ fontSize: '0.875rem', color: 'var(--brand-success)' }}>
          ...
          <div style={{
            ...
            <p style={{ color: 'var(--brand-text)', marginBottom: '1rem' }}>
              Workforce Innovation and Opportunity Act compliance for all Elevate Learn2Earn Workforce 
      ...
      <section style={{ marginBottom: '3rem' }}>
        ...
        <div style={{ backgroundColor: 'var(--brand-surface)', padding: '2rem', borderRadius: '8px', marginBottom: '2rem' }}>
          ...
          <ul style={{ listStyle: 'none', padding: 0 }}>
            <li style={{ padding: '0.25rem 0', color: 'var(--brand-text)' }}>✓ Screen reader compatibility</li>
            <li style={{ padding: '0.25rem 0', color: 'var(--brand-text)' }}>✓ Keyboard navigation support</li>
            <li style={{ padding: '0.25rem 0', color: 'var(--brand-text)' }}>✓ High contrast color schemes</li>
            <li style={{ padding: '0.25rem 0', color: 'var(--brand-text)' }}>✓ Alternative text for images</li>
            <li style={{ padding: '0.25rem 0', color: 'var(--brand-text)' }}>✓ Closed captioning for videos</li>
          </ul>
        </div>
      </section>
      ...
      <section style={{ marginBottom: '3rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem' }}>
          ...
          <div style={{
            ...
            <p style={{ color: 'var(--brand-text)', marginBottom: '1rem' }}>
              Eligible Training Provider List approval for Elevate Learn2Earn Workforce 
