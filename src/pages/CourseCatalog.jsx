...
const demoCourses = [
  {
    ...
    description: "Get certified in construction fundamentals with OSHA 10, NCCER Core, and Forklift certification.",
  ...
  },
  {
    ...
    description: "Become a certified phlebotomy technician with hands-on training and national certification prep.",
    duration: "8-10 weeks",
    students: 189,
    rating: 4.9,
    level: "Beginner",
  ...
  },
  {
    ...
    description: "Earn your CDL Class A license with comprehensive training and job placement assistance.",
    duration: "4-8 weeks",
    students: 312,
    rating: 4.7,
    level: "Beginner",
  ...
  },
  {
    ...
    description: "Prepare for the modern workforce with essential skills including resume writing and interview prep.",
    duration: "6 weeks",
    students: 456,
    rating: 4.6,
    level: "Beginner",
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {featuredCourses.map((course) => (
                <Card key={course.id} className="group hover:shadow-2xl transition-all duration-300 border-2 hover:border-blue-300">
