  ...
  return (
    <main style={{ padding: 32, background: "#f8fafc", minHeight: "100vh" }}>
      <Helmet>
        ...
        <meta name="keywords" content="LMS, government LMS, DOL compliant, Elevate Learn2Earn Workforce, online courses, best LMS, LearnWorlds alternative, LearnKey alternative, government contractor, digital binder, reporting, scholarship, dynamic LMS" />
        <meta property="og:title" content="Course Library | Elevate for Humanity" />
        <meta property="og:description" content="The #1 government-ready LMS for Elevate Learn2Earn Workforce, DOL/DOE/DWD compliance, and dynamic reporting. Outperform LearnWorlds and LearnKey." />
