    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-100">
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="bg-white p-8 rounded-xl shadow-lg">
            ...
            <p className="text-brand-text-muted mb-4">
              Get instant help from our AI tutor, available 24/7 to answer
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg">
            ...
            <p className="text-brand-text-muted mb-4">
              AI adjusts content difficulty and pace based on your performance
              and learning style
            </p>
            <Link
              to="/courses"
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg">
            ...
            <p className="text-brand-text-muted mb-4">
              Track your progress with AI-powered insights and personalized
              recommendations
            </p>
            <Link
              to="/dashboard"
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg">
            ...
            <p className="text-brand-text-muted mb-4">
              AI creates custom practice problems and study materials tailored
              to your needs
            </p>
            <Link
              to="/lms"
        ...
        <div className="bg-white p-12 rounded-xl shadow-lg text-center">
          ...
          <Link
            to="/get-started"
            className="bg-brand-info text-white px-8 py-4 rounded-lg font-semibold hover:bg-brand-info-hover transition inline-block"
          >
            Get Started Free
          </Link>
        </div>
