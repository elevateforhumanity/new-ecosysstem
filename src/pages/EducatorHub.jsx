        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <a href="/lms" className="text-brand-text-light hover:text-brand-text">LMS</a>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          ...
          <p className="mt-3 max-w-md mx-auto text-base text-brand-text-light sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            Empower your teaching with our comprehensive learning management system and curriculum resources.
          </p>
            ...
            <div className="pt-6">
              <div className="flow-root bg-white rounded-lg px-6 pb-8">
                <div className="-mt-6">
                  ...
                  <h3 className="mt-8 text-lg font-medium text-brand-text tracking-tight">Course Management</h3>
                  <p className="mt-5 text-base text-brand-text-light">
                    Create, organize, and manage courses with our intuitive learning management system.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6">
              <div className="flow-root bg-white rounded-lg px-6 pb-8">
                <div className="-mt-6">
                  ...
                  <h3 className="mt-8 text-lg font-medium text-brand-text tracking-tight">Student Analytics</h3>
                  <p className="mt-5 text-base text-brand-text-light">
            ...
            <div className="pt-6">
              <div className="flow-root bg-white rounded-lg px-6 pb-8">
                <div className="-mt-6">
                  ...
                  <h3 className="mt-8 text-lg font-medium text-brand-text tracking-tight">Curriculum Library</h3>
                  <p className="mt-5 text-base text-brand-text-light">
                    Access a comprehensive library of industry-aligned curriculum and teaching resources.
                  </p>
                </div>
              </div>
            </div>
