    ...
    <div className="min-h-screen bg-brand-surface">
      ...
      <div className="max-w-7xl mx-auto px-8 pb-16">
        ...
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12 text-[#1a365d]">Government Contract Capabilities</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-brand-surface p-8 rounded-xl border-l-4 border-blue-500 shadow-sm">
              <h3 className="text-xl font-semibold text-[#1a365d] mb-4">Workforce Development Services</h3>
              ...
              <ul className="space-y-2">
                <li className="text-brand-text"><span className="text-brand-success font-bold">✓</span> DOL/DWD/DOE Contract Ready</li>
                <li className="text-brand-text"><span className="text-brand-success font-bold">✓</span> WIOA/FERPA Compliant</li>
                <li className="text-brand-text"><span className="text-brand-success font-bold">✓</span> Performance-Based Outcomes</li>
                <li className="text-brand-text"><span className="text-brand-success font-bold">✓</span> Veteran Transition Programs</li>
                <li className="text-brand-text"><span className="text-brand-success font-bold">✓</span> Skills Assessment & Certification</li>
              </ul>
            </div>
            
            <div className="bg-brand-surface p-8 rounded-xl border-l-4 border-blue-500 shadow-sm">
              <h3 className="text-xl font-semibold text-[#1a365d] mb-4">Educational Services</h3>
              <p className="text-brand-text-muted mb-4">
              ...
              <ul className="space-y-2">
                <li className="text-brand-text"><span className="text-brand-success font-bold">✓</span> Industry-Recognized Certifications</li>
                <li className="text-brand-text"><span className="text-brand-success font-bold">✓</span> Hybrid Learning Delivery</li>
                <li className="text-brand-text"><span className="text-brand-success font-bold">✓</span> Accessibility Compliant (Section 508)</li>
                <li className="text-brand-text"><span className="text-brand-success font-bold">✓</span> Performance Tracking & Reporting</li>
                <li className="text-brand-text"><span className="text-brand-success font-bold">✓</span> Employer Partnership Programs</li>
              </ul>
            </div>
            
            <div className="bg-brand-surface p-8 rounded-xl border-l-4 border-blue-500 shadow-sm">
              <h3 className="text-xl font-semibold text-[#1a365d] mb-4">Compliance & Quality Assurance</h3>
              <p className="text-brand-text-muted mb-4">
                Full compliance with federal regulations and quality standards for government contracting and service delivery.
              </p>
              <ul className="space-y-2">
                <li className="text-brand-text"><span className="text-brand-success font-bold">✓</span> FedRAMP & FISMA Ready</li>
                <li className="text-brand-text"><span className="text-brand-success font-bold">✓</span> SOC 2 Type II Certified</li>
                <li className="text-brand-text"><span className="text-brand-success font-bold">✓</span> ISO 9001:2015 Quality Management</li>
                <li className="text-brand-text"><span className="text-brand-success font-bold">✓</span> WCAG 2.1 AA Accessibility</li>
                <li className="text-brand-text"><span className="text-brand-success font-bold">✓</span> Continuous Compliance Monitoring</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section id="performance" className="bg-[#1a365d] text-white py-16 px-8">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12">Proven Performance</h2>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 text-center">
            <div>
              <div className="text-5xl font-bold text-green-400 mb-2">98%</div>
              <div className="text-sm opacity-90">Contract Performance Rating</div>
            </div>
            <div>
            ...
            <div>
              <div className="text-5xl font-bold text-green-400 mb-2">$2.85M</div>
      ...
      <section id="contact" className="bg-brand-surface py-16 px-8">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12 text-[#1a365d]">Contact Our Government Contracting Team</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-sm border-t-4 border-blue-500">
              <h3 className="text-xl font-semibold text-[#1a365d] mb-4">Government Contracts</h3>
              <div className="text-brand-text-muted space-y-2">
                <p><strong className="text-brand-text">Email:</strong> government@elevateforhumanity.org</p>
                <p><strong className="text-brand-text">Phone:</strong> (555) 123-4567</p>
                <p><strong className="text-brand-text">CAGE Code:</strong> 9ABC1</p>
                <p><strong className="text-brand-text">DUNS:</strong> 123456789</p>
                <p><strong className="text-brand-text">NAICS:</strong> 611710, 541611, 541990</p>
              </div>
            </div>
            
            <div className="bg-white p-8 rounded-xl shadow-sm border-t-4 border-blue-500">
              <h3 className="text-xl font-semibold text-[#1a365d] mb-4">Proposal Submissions</h3>
              <div className="text-brand-text-muted space-y-2">
                <p><strong className="text-brand-text">RFP Response:</strong> proposals@elevateforhumanity.org</p>
                <p><strong className="text-brand-text">Capability Statements:</strong> Available upon request</p>
                <p><strong className="text-brand-text">Past Performance:</strong> References available</p>
                <p><strong className="text-brand-text">Security Clearance:</strong> Available as needed</p>
                <p><strong className="text-brand-text">Response Time:</strong> 24-48 hours</p>
              </div>
            </div>
            
            <div className="bg-white p-8 rounded-xl shadow-sm border-t-4 border-blue-500">
              <h3 className="text-xl font-semibold text-[#1a365d] mb-4">Program Management</h3>
              <div className="text-brand-text-muted space-y-2">
                <p><strong className="text-brand-text">Program Director:</strong> programs@elevateforhumanity.org</p>
                <p><strong className="text-brand-text">Quality Assurance:</strong> qa@elevateforhumanity.org</p>
                <p><strong className="text-brand-text">Compliance Officer:</strong> compliance@elevateforhumanity.org</p>
                <p><strong className="text-brand-text">Emergency Contact:</strong> (555) 123-4567</p>
                <p><strong className="text-brand-text">Hours:</strong> 24/7 Support Available</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <footer className="bg-[#2d3748] text-white py-8 px-8 text-center">
        <div className="max-w-7xl mx-auto">
          <p className="mb-2">&copy; 2024 Elevate for Humanity | Veteran-Owned Small Business</p>
          <p className="mb-2">CAGE Code: 9ABC1 | DUNS: 123456789 | VOSB Certified</p>
          <p className="text-sm opacity-90">Creating pathways to prosperity through professional workforce development</p>
        </div>
      </footer>
    </div>
  )
