      ...
      <div className="max-w-7xl mx-auto px-8 pb-16">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-8 rounded-xl border-l-4 border-blue-500 shadow-sm">
              ...
              <ul className="space-y-2">
                <li className="text-gray-700"><span className="text-green-600 font-bold">✓</span> DOL/DWD/DOE Contract Ready</li>
                <li className="text-gray-700"><span className="text-green-600 font-bold">✓</span> WIOA/FERPA Compliant</li>
                <li className="text-gray-700"><span className="text-green-600 font-bold">✓</span> Performance-Based Outcomes</li>
                <li className="text-gray-700"><span className="text-green-600 font-bold">✓</span> Veteran Transition Programs</li>
                <li className="text-gray-700"><span className="text-green-600 font-bold">✓</span> Skills Assessment & Certification</li>
              </ul>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-xl border-l-4 border-blue-500 shadow-sm">
              ...
              <ul className="space-y-2">
                <li className="text-gray-700"><span className="text-green-600 font-bold">✓</span> Industry-Recognized Certifications</li>
                <li className="text-gray-700"><span className="text-green-600 font-bold">✓</span> Hybrid Learning Delivery</li>
                <li className="text-gray-700"><span className="text-green-600 font-bold">✓</span> Accessibility Compliant (Section 508)</li>
                <li className="text-gray-700"><span className="text-green-600 font-bold">✓</span> Performance Tracking & Reporting</li>
                <li className="text-gray-700"><span className="text-green-600 font-bold">✓</span> Employer Partnership Programs</li>
              </ul>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-xl border-l-4 border-blue-500 shadow-sm">
              ...
              <ul className="space-y-2">
                <li className="text-gray-700"><span className="text-green-600 font-bold">✓</span> FedRAMP & FISMA Ready</li>
                <li className="text-gray-700"><span className="text-green-600 font-bold">✓</span> SOC 2 Type II Certified</li>
                <li className="text-gray-700"><span className="text-green-600 font-bold">✓</span> ISO 9001:2015 Quality Management</li>
                <li className="text-gray-700"><span className="text-green-600 font-bold">✓</span> WCAG 2.1 AA Accessibility</li>
                <li className="text-gray-700"><span className="text-green-600 font-bold">✓</span> Continuous Compliance Monitoring</li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-sm border-t-4 border-blue-500">
              ...
              <div className="text-gray-600 space-y-2">
                <p><strong className="text-gray-800">Email:</strong> government@elevateforhumanity.org</p>
                <p><strong className="text-gray-800">Phone:</strong> (555) 123-4567</p>
                <p><strong className="text-gray-800">CAGE Code:</strong> 9ABC1</p>
                <p><strong className="text-gray-800">DUNS:</strong> 123456789</p>
                <p><strong className="text-gray-800">NAICS:</strong> 611710, 541611, 541990</p>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border-t-4 border-blue-500">
              ...
              <div className="text-gray-600 space-y-2">
                <p><strong className="text-gray-800">RFP Response:</strong> proposals@elevateforhumanity.org</p>
                <p><strong className="text-gray-800">Capability Statements:</strong> Available upon request</p>
                <p><strong className="text-gray-800">Past Performance:</strong> References available</p>
                <p><strong className="text-gray-800">Security Clearance:</strong> Available as needed</p>
                <p><strong className="text-gray-800">Response Time:</strong> 24-48 hours</p>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border-t-4 border-blue-500">
              ...
              <div className="text-gray-600 space-y-2">
                <p><strong className="text-gray-800">Program Director:</strong> programs@elevateforhumanity.org</p>
                <p><strong className="text-gray-800">Quality Assurance:</strong> qa@elevateforhumanity.org</p>
                <p><strong className="text-gray-800">Compliance Officer:</strong> compliance@elevateforhumanity.org</p>
                <p><strong className="text-gray-800">Emergency Contact:</strong> (555) 123-4567</p>
                <p><strong className="text-gray-800">Hours:</strong> 24/7 Support Available</p>
              </div>
            </div>
          </div>
        </div>
