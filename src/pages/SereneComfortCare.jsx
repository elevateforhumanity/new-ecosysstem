...
export function SereneComfortCare() {
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#fff' }}>
      {/* Hero Section */}
      <div style={{ background: 'linear-gradient(135deg, var(--brand-success) 0%, var(--brand-success) 100%)', color: '#fff', padding: '4rem 2rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link to="/serene-comfort-care/services" style={{ padding: '1rem 2rem', backgroundColor: '#fff', color: 'var(--brand-success)', borderRadius: '0.5rem', fontWeight: '600', textDecoration: 'none', fontSize: '1.125rem' }}>
              Our Services
            </Link>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '2rem' }}>
            {[
              ...
              <div key={i} style={{ border: '1px solid var(--brand-border)', borderRadius: '0.5rem', padding: '2rem' }}>
                ...
                <Link to="/serene-comfort-care/apply" style={{ color: 'var(--brand-success)', fontWeight: '600', textDecoration: 'none' }}>
                  Apply Now →
                </Link>
              </div>
            ))}
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '2rem' }}>
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ color: 'var(--brand-text-muted)' }}>Every patient receives personalized, dignified care</p>
            </div>
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>🎓</div>
              <h3 style={{ fontSize: '1.25rem', fontWeight: '600', marginBottom: '0.5rem' }}>Expert Training</h3>
              <p style={{ color: 'var(--brand-text-muted)' }}>Learn from experienced healthcare professionals</p>
            </div>
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>📜</div>
              <h3 style={{ fontSize: '1.25rem', fontWeight: '600', marginBottom: '0.5rem' }}>State Certified</h3>
              <p style={{ color: 'var(--brand-text-muted)' }}>All programs meet state certification requirements</p>
            </div>
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: '3rem', marginBottom: '1rem' }}>💼</div>
              <h3 style={{ fontSize: '1.25rem', fontWeight: '600', marginBottom: '0.5rem' }}>Job Placement</h3>
              <p style={{ color: 'var(--brand-text-muted)' }}>Connect with healthcare employers upon graduation</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div style={{ background: 'linear-gradient(135deg, var(--brand-success) 0%, var(--brand-success) 100%)', color: '#fff', padding: '4rem 2rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link to="/serene-comfort-care/care-team" style={{ padding: '1rem 2rem', backgroundColor: '#fff', color: 'var(--brand-success)', borderRadius: '0.5rem', fontWeight: '600', textDecoration: 'none', fontSize: '1.125rem' }}>
              Meet Our Team
            </Link>
            <Link to="/serene-comfort-care/apply" style={{ padding: '1rem 2rem', backgroundColor: 'rgba(255,255,255,0.2)', color: '#fff', border: '2px solid #fff', borderRadius: '0.5rem', fontWeight: '600', textDecoration: 'none', fontSize: '1.125rem' }}>
              Apply Today
