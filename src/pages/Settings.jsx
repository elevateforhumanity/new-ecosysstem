                ...
                <label style={{ position: "relative", display: "inline-block", width: 50, height: 24 }}>
                  ...
                  <span
                    style={{
                      ...
                      right: 0,
                      bottom: 0,
                      backgroundColor: settings.emailNotifications ? "var(--brand-info)" : "#ccc",
                      borderRadius: 24,
                      transition: "0.3s",
                    }}
                  >
                ...
                <label style={{ position: "relative", display: "inline-block", width: 50, height: 24 }}>
                  ...
                  <span
                    style={{
                      ...
                      right: 0,
                      bottom: 0,
                      backgroundColor: settings.courseUpdates ? "var(--brand-info)" : "#ccc",
                      borderRadius: 24,
                      transition: "0.3s",
                    }}
                  >
                ...
                <label style={{ position: "relative", display: "inline-block", width: 50, height: 24 }}>
                  ...
                  <span
                    style={{
                      ...
                      right: 0,
                      bottom: 0,
                      backgroundColor: settings.weeklyDigest ? "var(--brand-info)" : "#ccc",
                      borderRadius: 24,
                      transition: "0.3s",
                    }}
                  >
                ...
                <label style={{ position: "relative", display: "inline-block", width: 50, height: 24 }}>
                  ...
                  <span
                    style={{
                      ...
                      right: 0,
                      bottom: 0,
                      backgroundColor: settings.marketingEmails ? "var(--brand-info)" : "#ccc",
                      borderRadius: 24,
                      transition: "0.3s",
                    }}
                  >
                ...
                <label style={{ position: "relative", display: "inline-block", width: 50, height: 24 }}>
                  ...
                  <span
                    style={{
                      ...
                      right: 0,
                      bottom: 0,
                      backgroundColor: settings.autoplay ? "var(--brand-info)" : "#ccc",
                      borderRadius: 24,
                      transition: "0.3s",
                    }}
                  >
                ...
                <label style={{ position: "relative", display: "inline-block", width: 50, height: 24 }}>
                  ...
                  <span
                    style={{
                      ...
                      right: 0,
                      bottom: 0,
                      backgroundColor: settings.subtitles ? "var(--brand-info)" : "#ccc",
                      borderRadius: 24,
                      transition: "0.3s",
                    }}
                  >
                ...
                <label style={{ position: "relative", display: "inline-block", width: 50, height: 24 }}>
                  ...
                  <span
                    style={{
                      ...
                      right: 0,
                      bottom: 0,
                      backgroundColor: settings.twoFactorAuth ? "var(--brand-info)" : "#ccc",
                      borderRadius: 24,
                      transition: "0.3s",
                    }}
                  >
                ...
                <label style={{ position: "relative", display: "inline-block", width: 50, height: 24 }}>
                  ...
                  <span
                    style={{
                      ...
                      right: 0,
                      bottom: 0,
                      backgroundColor: settings.publicProfile ? "var(--brand-info)" : "#ccc",
                      borderRadius: 24,
                      transition: "0.3s",
                    }}
                  >
                ...
                <label style={{ position: "relative", display: "inline-block", width: 50, height: 24 }}>
                  ...
                  <span
                    style={{
                      ...
                      right: 0,
                      bottom: 0,
                      backgroundColor: settings.showProgress ? "var(--brand-info)" : "#ccc",
                      borderRadius: 24,
                      transition: "0.3s",
                    }}
                  >
