...
export function UrbanBuildCrew() {
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#fff' }}>
      {/* Hero Section */}
      <div style={{ background: 'linear-gradient(135deg, var(--brand-warning) 0%, var(--brand-warning-hover) 100%)', color: '#fff', padding: '4rem 2rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link to="/urban-build-crew/courses" style={{ padding: '1rem 2rem', backgroundColor: '#fff', color: 'var(--brand-warning)', borderRadius: '0.5rem', fontWeight: '600', textDecoration: 'none', fontSize: '1.125rem' }}>
              View Courses
            </Link>
      ...
      {/* Features Section */}
      <div style={{ padding: '4rem 2rem', backgroundColor: 'var(--brand-surface)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '2rem' }}>
            {[
              ...
              <div key={i} style={{ border: '1px solid var(--brand-border)', borderRadius: '0.5rem', padding: '2rem' }}>
                ...
                <p style={{ color: 'var(--brand-text-muted)', marginBottom: '1.5rem', lineHeight: '1.6' }}>{program.desc}</p>
                <Link to="/urban-build-crew/courses" style={{ color: 'var(--brand-warning)', fontWeight: '600', textDecoration: 'none' }}>
                  Learn More →
                </Link>
              </div>
            ))}
      ...
      {/* Stats Section */}
      <div style={{ backgroundColor: 'var(--brand-surface)', padding: '4rem 2rem' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '2rem', textAlign: 'center' }}>
            <div>
              <div style={{ fontSize: '3rem', fontWeight: '700', color: 'var(--brand-warning)', marginBottom: '0.5rem' }}>500+</div>
              <div style={{ color: 'var(--brand-text-muted)', fontSize: '1.125rem' }}>Graduates Placed</div>
            </div>
            <div>
              <div style={{ fontSize: '3rem', fontWeight: '700', color: 'var(--brand-warning)', marginBottom: '0.5rem' }}>95%</div>
              <div style={{ color: 'var(--brand-text-muted)', fontSize: '1.125rem' }}>Job Placement Rate</div>
            </div>
            <div>
              <div style={{ fontSize: '3rem', fontWeight: '700', color: 'var(--brand-warning)', marginBottom: '0.5rem' }}>$45K</div>
              <div style={{ color: 'var(--brand-text-muted)', fontSize: '1.125rem' }}>Average Starting Salary</div>
            </div>
            <div>
              <div style={{ fontSize: '3rem', fontWeight: '700', color: 'var(--brand-warning)', marginBottom: '0.5rem' }}>50+</div>
              <div style={{ color: 'var(--brand-text-muted)', fontSize: '1.125rem' }}>Partner Companies</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div style={{ background: 'linear-gradient(135deg, var(--brand-warning) 0%, var(--brand-warning-hover) 100%)', color: '#fff', padding: '4rem 2rem', textAlign: 'center' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link to="/urban-build-crew/about" style={{ padding: '1rem 2rem', backgroundColor: '#fff', color: 'var(--brand-warning)', borderRadius: '0.5rem', fontWeight: '600', textDecoration: 'none', fontSize: '1.125rem' }}>
              About Us
            </Link>
            <Link to="/urban-build-crew/contact" style={{ padding: '1rem 2rem', backgroundColor: 'rgba(255,255,255,0.2)', color: '#fff', border: '2px solid #fff', borderRadius: '0.5rem', fontWeight: '600', textDecoration: 'none', fontSize: '1.125rem' }}>
              Apply Now
      ...
      {/* Footer */}
      <div style={{ backgroundColor: 'var(--brand-text)', color: '#fff', padding: '2rem', textAlign: 'center' }}>
