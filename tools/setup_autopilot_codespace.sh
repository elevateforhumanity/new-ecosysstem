...
# --- Enhanced Cloudflare Pages GitHub Actions workflow ---
# Only create if pages.yml doesn't exist to avoid overwriting existing cloudflare-pages.yml
...
YAML
  ...
  echo "ℹ .github/workflows/pages.yml already exists, skipping"
fi
...
# --- Optional: Terraform workflow for infrastructure ---
if [ ! -f .github/workflows/infra.yml ]; then
  ...
  terraform:
    ...
    steps:
      ...
      - name: Terraform Plan
        ...
        env:
          TF_VAR_cf_api_token: ${{ secrets.CF_API_TOKEN }}
          TF_VAR_zone_name: ${{ secrets.CF_ZONE_NAME }}
      ...
      - name: Terraform Apply
        ...
        env:
          ...
          TF_VAR_zone_name: ${{ secrets.CF_ZONE_NAME }}
YAML
  echo "✅ Created .github/workflows/infra.yml"
else
  echo "ℹ .github/workflows/infra.yml already exists, skipping"
fi

# --- Enhanced Devcontainer to speed Codespaces ---
cat > .devcontainer/devcontainer.json <<'JSON'
{
  ...
  "postCreateCommand": "npm i -g pm2 wrangler && npm ci",
  "forwardPorts": [5173, 3000, 9200, 9300, 4100],
  "portsAttributes": {
    "5173": {
